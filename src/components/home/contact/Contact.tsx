            ...
            {socialLinks.map((social) => (
              <li key={social.name}>
                <Link
                  ...
                  className="bg-navigation-border flex w-full items-center justify-center gap-4 rounded-xl p-2 text-xl font-bold transition-all duration-150 hover:-translate-y-0.5 md:text-2xl lg:text-3xl"
                  href={social.link}
                >
                  <img
                    draggable={false}
